...
Outputs (into ../src/, i.e. geoscribe/src/):
  * registry.bin.zst  — the GCR1 image (see ../plans/registry-format.org), zstd-compressed
...
../plans/registry-format.org § USER-BUILT BLOBS.
...
def write_names(names) -> None:
    lines = [
        "//! GENERATED by tools/gen_crs_registry.py — do not edit by hand.",
        "//!",
        "//! Name → (authority, code) index; code is a string. Sorted by name so",
        "//! callers can binary search it (name→code recovery, milestone R2, used by",
        "//! geosetta's `names_matching` in `src/crs/registry.rs`).",
        "",
